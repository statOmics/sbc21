...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/cholQQ-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/dnaQQ-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/bernoulli-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/binoms-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/pitests-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/hamsterKooi-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brcaTab \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(brca}\OperatorTok{$}\NormalTok{variant, brca}\OperatorTok{$}\NormalTok{cancer)}
\NormalTok{brcaTab}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{brcaTab2 \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(brca}\OperatorTok{$}\NormalTok{variant2, brca}\OperatorTok{$}\NormalTok{cancer)}
\NormalTok{brcaTab2}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/chidist-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{OR \textless{}{-}}\StringTok{ }\KeywordTok{exp}\NormalTok{(posthocBI}\OperatorTok{$}\NormalTok{confint)}
\NormalTok{OR}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{table}\NormalTok{(beetles}\OperatorTok{$}\NormalTok{dose, beetles}\OperatorTok{$}\NormalTok{status)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{beetlesTab \textless{}{-}}\StringTok{ }\KeywordTok{table}\NormalTok{(beetles) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{data.frame}

\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{grid =} \KeywordTok{seq}\NormalTok{(}\KeywordTok{min}\NormalTok{(beetles}\OperatorTok{$}\NormalTok{dose), }\KeywordTok{max}\NormalTok{(beetles}\OperatorTok{$}\NormalTok{dose), }
    \FloatTok{0.1}\NormalTok{)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{piHat =} \KeywordTok{predict}\NormalTok{(beetleModel, }\DataTypeTok{newdata =} \KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{dose =}\NormalTok{ grid), }
    \DataTypeTok{type =} \StringTok{"response"}\NormalTok{)) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(grid, piHat)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_line}\NormalTok{() }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{"dose"}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{"probability (dead)"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_text}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ dose }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{as.character }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{as.double, }
        \DataTypeTok{y =}\NormalTok{ status }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{as.character }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{as.double, }
        \DataTypeTok{label =}\NormalTok{ Freq), beetlesTab }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(status }\OperatorTok{==}\StringTok{ }
\StringTok{        }\DecValTok{0}\NormalTok{)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom\_text}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ dose }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{as.character }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\NormalTok{as.double, }\DataTypeTok{y =}\NormalTok{ status }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{as.character }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{as.double, }
    \DataTypeTok{label =}\NormalTok{ Freq), beetlesTab }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{filter}\NormalTok{(status }\OperatorTok{==}\StringTok{ }
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/keversFit-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{prostate}\OperatorTok{$}\NormalTok{svi \textless{}{-}}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(prostate}\OperatorTok{$}\NormalTok{svi)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/lpsaAll-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/prosAdditiveFit-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/prosLinDiag1-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/prosIntFit2-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/prosIntFit1-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/vetScatter-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/influential-1} 
...
\KeywordTok{plot}\NormalTok{(lmVWS\_IntVW, }\DataTypeTok{which =} \DecValTok{5}\NormalTok{)}
...
\KeywordTok{plot}\NormalTok{(}\KeywordTok{cooks.distance}\NormalTok{(lmVWS\_IntVW), }\DataTypeTok{type =} \StringTok{"h"}\NormalTok{, }\DataTypeTok{ylim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }
    \DecValTok{1}\NormalTok{), }\DataTypeTok{main =} \StringTok{"Model with lcavol:lweight interaction"}\NormalTok{)}
\KeywordTok{abline}\NormalTok{(}\DataTypeTok{h =} \KeywordTok{qf}\NormalTok{(}\FloatTok{0.5}\NormalTok{, }\KeywordTok{length}\NormalTok{(lmVWS\_IntVW}\OperatorTok{$}\NormalTok{coef), }\KeywordTok{nrow}\NormalTok{(prostate) }\OperatorTok{{-}}\StringTok{ }
\StringTok{    }\KeywordTok{length}\NormalTok{(lmVWS\_IntVW}\OperatorTok{$}\NormalTok{coef)), }\DataTypeTok{lty =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/prosCooksAdditiveInt-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/prosDfBetasAdditive-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/prosDfBetasInt-1} 
...
{\centering \includegraphics[width=1\linewidth]{Statistiek_2020_2021_files/figure-latex/prosInfl-1} 
...
\includegraphics{Statistiek_2020_2021_files/figure-latex/unnamed-chunk-259-1.pdf}
...
\includegraphics{Statistiek_2020_2021_files/figure-latex/unnamed-chunk-260-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mSd \textless{}{-}}\StringTok{ }\KeywordTok{lm}\NormalTok{(mBp1}\OperatorTok{$}\NormalTok{res }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\NormalTok{abs }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{mBp2}\OperatorTok{$}\NormalTok{fitted)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mBp3 \textless{}{-}}\StringTok{ }\KeywordTok{lm}\NormalTok{(BPSysAve }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{Age }\OperatorTok{*}\StringTok{ }\NormalTok{Gender, bpData, }\DataTypeTok{w =} \DecValTok{1}\OperatorTok{/}\NormalTok{mSd}\OperatorTok{$}\NormalTok{fitted}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{residuals =}\NormalTok{ mBp3}\OperatorTok{$}\NormalTok{residuals, }\DataTypeTok{fit =}\NormalTok{ mBp3}\OperatorTok{$}\NormalTok{fitted) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{    }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(fit, residuals)) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom\_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{Statistiek_2020_2021_files/figure-latex/unnamed-chunk-263-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{scaled\_residuals =}\NormalTok{ mBp3}\OperatorTok{$}\NormalTok{residuals}\OperatorTok{/}\NormalTok{mSd}\OperatorTok{$}\NormalTok{fitted, }
    \DataTypeTok{fit =}\NormalTok{ mBp3}\OperatorTok{$}\NormalTok{fitted) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(fit, scaled\_residuals)) }\OperatorTok{+}\StringTok{ }
\StringTok{    }\KeywordTok{geom\_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{Statistiek_2020_2021_files/figure-latex/unnamed-chunk-264-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mBp0 \textless{}{-}}\StringTok{ }\KeywordTok{lm}\NormalTok{(BPSysAve }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{Gender, bpData, }\DataTypeTok{w =} \DecValTok{1}\OperatorTok{/}\NormalTok{mSd}\OperatorTok{$}\NormalTok{fitted}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{)}
\KeywordTok{anova}\NormalTok{(mBp0, mBp3)}
\end{Highlighting}
\end{Shaded}
